...
type: page
summary: Academic CV of Apostolos Mavrogiannakis
---
...
[Download PDF Version](/uploads/cv.pdf)
...
3. **Apostolos Mavrogiannakis**, Collaborator Four, Collaborator Five. "Privacy-Preserving Machine Learning with Cryptographic Guarantees." *arXiv preprint arXiv:2401.xxxxx*, 2024. -->
...
[Tech Company], Security & Privacy Team
- Developed novel cryptographic protocols for privacy-preserving analytics
- Implemented prototype systems demonstrating 10x performance improvements
- Contributed to open-source cryptographic libraries

**Research Assistant** | Jan 2019 - Aug 2020
[Previous University], Systems Security Lab
- Investigated vulnerabilities in distributed systems
- Developed secure communication protocols for IoT devices -->
...
<!-- ---
- **Best Paper Award**, IEEE Security & Privacy Conference, 2024
- **NSF Graduate Research Fellowship**, 2021-2024
- **Outstanding Graduate Student Award**, UC Santa Cruz CS Dept, 2023
- **Conference Travel Grant**, USENIX Security Symposium, 2024
- **Dean's List**, Undergraduate University, 2014-2018 -->
...
- Graduate Student Representative, CS Department, 2023-2024
- Mentor for undergraduate research students (3 students) -->
...
**Efficient ORAM Implementation** | [GitHub](https://github.com/mavrogiannakisap/efficient-oram)
High-performance implementation of tree-based ORAM with 40% reduced communication overhead

**Scalable MPC Framework** | [GitHub](https://github.com/mavrogiannakisap/scalable-mpc)
